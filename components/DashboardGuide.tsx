...
const STEPS: StepCopy[] = [
  ...
  // ------- PHASE B: Launch an event -------
  {
    ...
    tournamentNote:
      "Tournament = multi-team commitment contest. Host sets a per-team Entry Fee; other teams pay it to join via a 6-character join code. Strict scoring: a team earns a challenge's points only when every player completes it. Top teams win the prize pot.",
