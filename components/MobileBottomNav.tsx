...
export default function MobileBottomNav({ active }: MobileBottomNavProps) {
  const items: Array<{ key: NavKey | "account"; label: string; href: string; icon: React.ReactNode }> = [
    ...
    { key: "events", label: "Events", href: "/dashboard?view=events", icon: CalendarIcon },
    { key: "teams", label: "Teams", href: "/dashboard?view=teams", icon: TeamsIcon },
    { key: "participants", label: "Players", href: "/dashboard?view=participants", icon: PlayersIcon },
    { key: "account", label: "Account", href: "/dashboard?view=settings", icon: AccountIcon },
  ];
  return (
